...
`functions_main.ino`와 `functions_etc.ino`를 뺀 나머지 탭들은 다음 내용에서 자세하게 다룰 예정입니다. 그리고 원본 소스 코드는 깃허브 링크[(바로가기)](https://www.google.com/search?q=https://github.com/seonghoon0905/AVDGroupAProject) 에서 확인하실 수 있으니 참고해 주세요!
